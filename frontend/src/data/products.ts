...
export const products: Product[] = [
  ...
  { 
    id: 'eg-1', 
    name: 'Ultra-Slim Premium Laptop', 
    category: 'Electronic Goods', 
    price: 124900, 
    image: '/images/electronic-1.jpg', 
    description: 'Power beyond boundaries. This ultra-slim laptop features the latest 14-core processor, a stunning OLED display with 100% DCI-P3 coverage, and a whisper-quiet cooling system. Housed in a precision-milled aluminum chassis for ultimate portability and strength.' 
  },
  { 
    id: 'eg-2', 
    ...
    description: 'Silence the world, hear the music. Our flagship headphones provide industry-leading active noise cancellation and high-fidelity spatial audio. Featuring memory foam ear cushions and a 40-hour battery life for uninterrupted listening luxury.' 
  },
  { 
    id: 'eg-3', 
    name: 'Flagship Smartphone S24 Ultra', 
    category: 'Electronic Goods', 
    price: 109900, 
  ...
  { 
    id: 'eg-5', 
    name: 'Titanium Smartwatch Edition', 
    category: 'Electronic Goods', 
    price: 44900, 
  ...
  { 
    id: 'eg-8', 
    name: 'Ultra-Fast External SSD 2TB', 
    category: 'Electronic Goods', 
    price: 18900, 
  ...
  { 
    id: 'eg-9', 
    name: '4K Mirrorless Cinema Camera', 
    category: 'Electronic Goods', 
    price: 189000, 
  ...
  { 
    id: 'eg-11', 
    name: 'Smart Powerbank 40K Elite', 
    category: 'Electronic Goods', 
    price: 8900, 
  ...
  { 
    id: 'eg-12', 
    name: 'Wireless High-Precision Mouse', 
    category: 'Electronic Goods', 
    price: 11900, 
  ...
  { 
    id: 'eg-13', 
    name: 'Noise-Isolation Earbuds Pro', 
    category: 'Electronic Goods', 
    price: 18900, 
  ...
  { 
    id: 'eg-16', 
    name: 'Handheld Gaming Console Ultra', 
    category: 'Electronic Goods', 
    price: 59900, 
  ...
  { 
    id: 'eg-17', 
    name: 'Smart Microphone Studio MK2', 
    category: 'Electronic Goods', 
    price: 24900, 
  ...
  { 
    id: 'eg-31', 
    name: 'Portable Projector Cinema', 
    category: 'Electronic Goods', 
    price: 64900, 
    image: '/images/laptop.png', 
  ...
  { 
    id: 'eg-36', 
    name: 'Wireless Guitar Transmitter', 
    category: 'Electronic Goods', 
    price: 14900, 
    image: '/images/briefcase.png', 
  ...
  { 
    id: 'eg-38', 
    name: 'Modular Mechanical Keyboard', 
    category: 'Electronic Goods', 
    price: 34900, 
    image: '/images/backpack.png', 
  ...
  { 
    id: 'eg-39', 
    name: 'Pro Studio Reference Ears', 
    category: 'Electronic Goods', 
    price: 49900, 
    image: '/images/wallet.png', 
  ...
  { 
    id: 'eg-40', 
    name: 'Multi-GPU External Chassis', 
    category: 'Electronic Goods', 
    price: 39900, 
    image: '/images/messenger.png', 
  ...
  { 
    id: 'eg-41', 
    name: 'Smart Digital Scale Elite', 
    category: 'Electronic Goods', 
    price: 11900, 
    image: '/images/electronic-1.jpg', 
  ...
  { 
    id: 'eg-45', 
    name: 'Desktop Audio Interface Pro', 
    category: 'Electronic Goods', 
    price: 44900, 
    image: '/images/electronic-5.jpg', 
  ...
  { id: 'he-6', name: 'Smart Air Purifier Elite', category: 'Home Electronics', price: 32900, image: '/images/laptop.png', description: 'Breathe easier. Our Elite air purifier captures 99.97% of airborne particles, including allergens and pollutants. Real-time air quality sensors automatically adjust the fan speed, and the minimalist design fits perfectly in any modern room.' },
  { id: 'he-7', name: 'Convection Microwave Pro', category: 'Home Electronics', price: 21900, image: '/images/headphones.png', description: 'Versatile cooking made simple. This premium microwave combines convection, grill, and microwave tech. Precision sensors ensure even heating for everything from quick snacks to complex roasts. Elegant touch controls and a ceramic interior.' },
  { id: 'he-8', name: 'Espresso Coffee Machine Pro', category: 'Home Electronics', price: 89900, image: '/images/smartphone.png', description: 'Be your own barista. This dual-boiler espresso machine provides commercial-grade performance at home. Precise PID temperature control and a powerful steam wand ensure you get the perfect shot and silky micro-foam every single morning.' },
  { id: 'he-9', name: 'Smart Induction Cooktop', category: 'Home Electronics', price: 34900, image: '/images/tablet.png', description: 'Precision meet speed. Our induction cooktop boils water in seconds and offers exact temperature control for delicate sauces. Featuring an intuitive bridge mode for large pans and a sleek, easy-to-clean glass surface.' },
  { id: 'he-10', name: 'Heim-Cinema Soundbar 7.1', category: 'Home Electronics', price: 64900, image: '/images/smartwatch.png', description: 'Sound that surrounds you. This 7.1.4 channel soundbar features up-firing drivers for true Dolby Atmos immersion. Calibrates to your room automatically to deliver crystal clear dialogue and earth-shaking bass without the wire clutter.' },
  { id: 'he-11', name: 'Quiet Dishwasher Series 9', category: 'Home Electronics', price: 84900, image: '/images/briefcase.png', description: 'Silent but powerful. This premium dishwasher operates at a near-inaudible 38dB. Featuring a 3rd rack for cutlery and high-temperature steam wash for surgical-level clean. Smart connectivity notifies you when the cycle is done.' },
  { id: 'he-12', name: 'Smart Humidifier 500 Evo', category: 'Home Electronics', price: 14900, image: '/images/duffle.png', description: 'Perfect humidity, all the time. Our advanced humidifier features UV-C light to kill 99.9% of bacteria in the water before it\'s misted. Quiet enough for the bedroom and smart enough to maintain your desired humidity level automatically.' },
  { id: 'he-13', name: 'Water Purifier RO+UV Pro', category: 'Home Electronics', price: 28900, image: '/images/backpack.png', description: 'The purest water for your family. This 8-stage purification system removes dissolved solids, bacteria, and viruses. Features an integrated mineralizer to ensure your water isn\'t just clean, but healthy and great-tasting.' },
  { id: 'he-14', name: 'Digital Steam Iron Pro', category: 'Home Electronics', price: 8900, image: '/images/wallet.png', description: 'Effortless ironing. Our digital steam iron features an optimal temperature setting that is safe for all fabrics. High-pressure steam penetrates deep into fibers to remove even the most stubborn wrinkles in a single pass.' },
  { id: 'he-15', name: 'Smart Door Lock Pro Ultra', category: 'Home Electronics', price: 22900, image: '/images/messenger.png', description: 'Security at your fingertips. Unlock your home via fingerprint, phone, or custom codes. Track every entry and exit with the companion app and provide temporary access codes for guests or service providers.' },
  { id: 'he-16', name: 'Home Security Cam 4K 360', category: 'Home Electronics', price: 12900, image: '/images/tv.png', description: 'Total visibility, night and day. This 4K pan-and-tilt security camera features AI human detection and full-color night vision. Integrated two-way audio allows you to communicate with anyone at home from anywhere in the world.' },
